---
id: upanishads/chandogya/prapathaka_06_public_domain_translation
title: Chandogya Upanishad - Sixth Prapathaka (Max Muller Public Domain Translation)
source_title: Chandogya Upanishad
source_type: primary_text
tradition:
- upanishadic
author: Friedrich Max Muller
section: prapathaka_06
...
notes:
- "Public-domain translation inspected at https://en.wikisource.org/wiki/Sacred_Books_of_the_East/Volume_1/Kh%C3%A2ndogya-upanishad/Sixth_Prap\xE2\
  thaka"
- Partial import of the Sixth Prapathaka from English Wikisource SBE Volume 1.
copyright_status: public_domain
status: imported_public_domain
citation: Friedrich Max Muller, Chandogya Upanishad, Sixth Prapathaka (Sacred Books
  of the East, Volume 1, public domain)
normalized_from: /workspace/content/sources/upanishads/chandogya/prapathaka_06.public_domain.md
normalized_sections:
- Public-Domain Translation
- Source Provenance
---

# Chandogya Upanishad - Sixth Prapathaka (Max Muller Public Domain Translation)
...
'And how these three beings (devatâ), fire, water, earth, O son, when they reach man, become each of them tripartite, has been said before (VI, 4, 7). When a man departs from hence, his speech is merged in his mind, his mind in his breath, his breath in heat (fire), heat in the Highest Being.
...
2. 'But if the life (the living Self) leaves one of its branches, that branch withers; if it leaves at second, that branch withers; if it leaves a third, that branch withers. If it leaves the whole tree, the whole tree withers. In exactly the same manner, my son, know this.' Thus he spoke:
...
- Imported from https://en.wikisource.org/wiki/Sacred_Books_of_the_East/Volume_1/Kh%C3%A2ndogya-upanishad/Sixth_Prapâthaka.
