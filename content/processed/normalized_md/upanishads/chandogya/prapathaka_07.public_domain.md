---
id: upanishads/chandogya/prapathaka_07_public_domain_translation
title: Chandogya Upanishad - Seventh Prapathaka (Max Muller Public Domain Translation)
source_title: Chandogya Upanishad
source_type: primary_text
tradition:
- upanishadic
author: Friedrich Max Muller
section: prapathaka_07
...
notes:
- "Public-domain translation inspected at https://en.wikisource.org/wiki/Sacred_Books_of_the_East/Volume_1/Kh%C3%A2ndogya-upanishad/Seventh_Prap\xE2\
  thaka"
- Partial import of the Seventh Prapathaka from English Wikisource SBE Volume 1.
copyright_status: public_domain
status: imported_public_domain
citation: Friedrich Max Muller, Chandogya Upanishad, Seventh Prapathaka (Sacred Books
  of the East, Volume 1, public domain)
normalized_from: /workspace/content/sources/upanishads/chandogya/prapathaka_07.public_domain.md
normalized_sections:
- Public-Domain Translation
- Source Provenance
---

# Chandogya Upanishad - Seventh Prapathaka (Max Muller Public Domain Translation)
...
- Imported from https://en.wikisource.org/wiki/Sacred_Books_of_the_East/Volume_1/Kh%C3%A2ndogya-upanishad/Seventh_Prapâthaka.
