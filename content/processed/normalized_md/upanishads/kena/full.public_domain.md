---
id: upanishads/kena/full_public_domain_translation
...
related_sources:
- upanishads/kena/index
notes:
- Public-domain translation inspected at https://en.wikisource.org/wiki/Sacred_Books_of_the_East/Volume_1/Talavak%C3%A2ra-upanishad
...
citation: Friedrich Max Muller, The Upanishads, Part 1 (SBE 1), Talavakara-Upanishad
  (Kena Upanishad), 1879
normalized_from: /workspace/content/sources/upanishads/kena/full.public_domain.md
normalized_sections:
...
# Kena Upanishad - Max Muller 1879 Public Domain Translation
...
2. Therefore these Devas, viz. Agni, Vâyu, and Indra, are, as it were, above the other gods, for they touched it (the Brahman) nearest.
...
- Imported from https://en.wikisource.org/wiki/Sacred_Books_of_the_East/Volume_1/Talavak%C3%A2ra-upanishad.
