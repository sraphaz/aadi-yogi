---
id: upanishads/isha/full_public_domain_translation
...
- action_without_possession
- divine_in_world
avoid_for:
- technical_ritual_instruction
related_sources:
- upanishads/isha/index
- upanishads/isha/mantra_01
notes:
- Public-domain translation inspected at https://en.wikisource.org/wiki/Sacred_Books_of_the_East/Volume_1/V%C3%A2gasaneyi-samhit%C3%A2-upanishad
- Volume page inspected at https://en.wikisource.org/wiki/Sacred_Books_of_the_East/Volume_1
- Imported from the English Wikisource witness of Sacred Books of the East.
copyright_status: public_domain
status: imported_public_domain
citation: "Friedrich Max Muller, The Upanishads, Part 1 (SBE 1), Isha Upanishad (V\xE2\
  gasaneyi-samhit\xE2), 1879"
normalized_from: /workspace/content/sources/upanishads/isha/full.public_domain.md
normalized_sections:
...
# Isha Upanishad - Max Muller 1879 Public Domain Translation

## Normalized Primary Text

→

sister projects: Wikipedia article, quotes, Wikidata item

Also known as Îsâvâsya-upanishad or Îsâ-upanishad.

1372168Sacred Books of the East Volume 1 — Vâgasaneyi-samhitâ-upanishadFriedrich Max MüllerUnknown
...
- Imported from https://en.wikisource.org/wiki/Sacred_Books_of_the_East/Volume_1/V%C3%A2gasaneyi-samhit%C3%A2-upanishad.
- Volume witness inspected at https://en.wikisource.org/wiki/Sacred_Books_of_the_East/Volume_1.
